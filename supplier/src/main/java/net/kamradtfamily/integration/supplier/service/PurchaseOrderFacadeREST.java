 ...
 */
@Stateless
@Path("net.kamradtfamily.integration.supplier.data.purchaseorder")
public class PurchaseOrderFacadeREST extends AbstractFacade<PurchaseOrder> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Long id, PurchaseOrder entity) {
        super.edit(entity);
    }
    ...
    public PurchaseOrder find(@PathParam("id") Long id) {
